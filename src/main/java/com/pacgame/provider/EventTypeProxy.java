...
public class EventTypeProxy<T extends EventProxy> extends Proxy {
     ...
     */
    private static final EventType<KeyEvent> KEY_RELEASED = KeyEvent.KEY_RELEASED;
     ...
     * fields are not used.
     */
    private static final EventType<KeyEvent> KEY_TYPED = KeyEvent.KEY_TYPED;

    /**
     * Common supertype for all mouse event types.
     */
    private static final EventType<MouseEvent> MOUSE_ANY = MouseEvent.ANY;
     ...
     */
    private static final EventType<MouseEvent> MOUSE_PRESSED = MouseEvent.MOUSE_PRESSED;
     ...
     */
    private static final EventType<MouseEvent> MOUSE_RELEASED = MouseEvent.MOUSE_RELEASED;
     ...
     */
    private static final EventType<MouseEvent> MOUSE_CLICKED = MouseEvent.MOUSE_CLICKED;
     ...
     */
    private static final EventType<MouseEvent> MOUSE_ENTERED_TARGET = MouseEvent.MOUSE_ENTERED_TARGET;
     ...
     * @see MouseEvent MouseEvent for more information about mouse entered/exited handling
     */
    private static final EventType<MouseEvent> MOUSE_ENTERED = MouseEvent.MOUSE_ENTERED;
     ...
     * @see MouseEvent MouseEvent for more information about mouse entered/exited handling
     */
    private static final EventType<MouseEvent> MOUSE_EXITED_TARGET = MouseEvent.MOUSE_EXITED_TARGET;
     ...
     * @see MouseEvent MouseEvent for more information about mouse entered/exited handling
     */
    private static final EventType<MouseEvent> MOUSE_EXITED = MouseEvent.MOUSE_EXITED;
     ...
     * occurs instead.
     */
    private static final EventType<MouseEvent> MOUSE_MOVED = MouseEvent.MOUSE_MOVED;
     ...
     */
    private static final EventType<MouseEvent> MOUSE_DRAGGED = MouseEvent.MOUSE_DRAGGED;
     ...
     */
    private static final EventType<MouseEvent> MOUSE_DRAG_DETECTED = MouseEvent.DRAG_DETECTED;
    ...
    public EventTypeProxy(String name) {
        this.proxyObject = createProxy(name);
    }

    public EventTypeProxy(final EventTypeProxy superType,
                     final String name)
    {

        proxyObject = createProxy(name);
    }

    protected EventType<? extends Event> getProxyObject() {
        return proxyObject;
    }

    private EventType createProxy(String name) {
        try {
            T type = clazz.newInstance();
            if (type instanceof KeyEventProxy) {
                return createKeyEventType(name);
            } else if (type instanceof MouseEventProxy) {
