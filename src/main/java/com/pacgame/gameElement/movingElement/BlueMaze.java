...
public class BlueMaze extends Maze {
    public static final String PREFIX_IMAGE_URL = "./enemy/blue/";

    public BlueMaze(Rectangle providedObject, ColorFactory colorFactory) {
